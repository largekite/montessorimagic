...
const NAV_LINKS = [
      ...
      { href: '/dashboard/children', label: 'Child Profile' },
      { href: '/dashboard/children/[id]', label: 'Child Detail' },
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-white border-b border-slate-100 px-6 h-14 flex items-center justify-between shrink-0">
        <Link href="/dashboard" className="font-bold text-slate-900">MontessoriMagic</Link>
